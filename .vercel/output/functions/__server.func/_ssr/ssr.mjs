...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BoPLp7J4.mjs");
...
var manifest = {
	"10ad411d33e64a585d2cede8d6854d740cc69d8ce5a44129943eb87d1d1b4be9": {
		functionName: "sendTrackRequest_createServerFn_handler",
		importer: () => import("./radio-fn-DI5-WTR0.mjs")
	},
	"58333d92f983e6ca3c212c3a03fe714d429da3c8c9f57f3c2a839ce91a4721b4": {
		functionName: "voteReaction_createServerFn_handler",
		importer: () => import("./radio-fn-DI5-WTR0.mjs")
	},
	"bf96ac8e67814a40154603ed74d2677ef6314ce64884c74720583ba5681aacc0": {
		functionName: "getStreamStats_createServerFn_handler",
		importer: () => import("./radio-fn-DI5-WTR0.mjs")
	},
	"e67de05bd3c0adade3a323e8ea8f39a0fb86750c0c14dd14ccacee3cb7425c19": {
		functionName: "getReactions_createServerFn_handler",
		importer: () => import("./radio-fn-DI5-WTR0.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BuAgjU6D.mjs").then((n) => n.t),
