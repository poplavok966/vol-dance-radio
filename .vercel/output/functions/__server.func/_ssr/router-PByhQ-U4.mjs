...
import { a as TriangleAlert, c as Play, d as Moon, l as Pause, n as VolumeX, o as Sun, p as LoaderCircle, r as Volume2, s as Radio, v as Clock } from "../_libs/lucide-react.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-PByhQ-U4.js
...
function HashLink({ hash, className, children }) {
...
function SiteHeader() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto flex w-full max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: "hidden text-[10px] font-semibold tracking-[0.22em] text-muted uppercase sm:block",
							children: t("live")
						})]
					})]
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UaFlag, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "hidden sm:inline",
								children: t("uaShort")
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "hidden items-center gap-1.5 rounded-full border border-border bg-secondary px-2.5 py-1.5 text-xs text-accent sm:inline-flex",
						...
						temp && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "hidden rounded-full border border-border bg-secondary px-2.5 py-1.5 text-xs md:inline-flex",
...
var styles_default = "/assets/styles-DyULiWbL.css";
